...
export default function Contact() {
  ...
  const inputCls =
    'w-full px-4 py-3 sm:py-3.5 lg:py-4 rounded-xl text-sm sm:text-base lg:text-[17px] xl:text-lg text-text-primary placeholder:text-text-muted/60 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/30 focus:shadow-[0_0_20px_rgba(0,255,204,0.08)] transition-all duration-300';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-10">
            ...
            >
              <div className="p-5 sm:p-7 rounded-2xl glass-card aura-border">
                <h3 className="font-heading text-base sm:text-lg lg:text-xl font-bold text-text-primary mb-5 sm:mb-6">
                  Why Work With Me
                </h3>
                <div className="space-y-4 sm:space-y-5">
                  {workHighlights.map((item) => (
                    <div key={item.text} className="flex items-center gap-3.5">
                      ...
                      <span className="text-sm sm:text-[15px] lg:text-[17px] xl:text-base text-text-secondary font-medium">{item.text}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="p-5 sm:p-7 rounded-2xl glass-card aura-border">
                ...
                <div className="space-y-4">
                  {contactChannels.map((ch) => (
                    ...
                    >
                      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 group-hover:shadow-[0_0_12px_rgba(0,255,204,0.15)] transition-all duration-300">
                        {ch.iconNode}
                      </div>
                      <div className="min-w-0">
                        <div className="text-[10px] sm:text-[11px] lg:text-xs text-text-muted uppercase tracking-wider font-semibold">{ch.label}</div>
                        <div className="text-sm sm:text-base lg:text-[17px] xl:text-lg text-text-primary font-semibold group-hover:text-primary-light transition-colors mt-0.5 break-all">{ch.value}</div>
                        <div className="text-[11px] sm:text-xs lg:text-[13px] text-text-muted mt-0.5">{ch.description}</div>
                      </div>
              ...
              <div className="p-4 sm:p-5 rounded-2xl glass-card !border-emerald/15 relative overflow-hidden">
                ...
                <div className="relative flex items-center gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm sm:text-[15px] lg:text-[17px] font-semibold text-text-primary">Morocco</span>
                  </div>
                ...
                <div className="relative flex items-center gap-2 mt-2.5">
                  ...
                  <span className="text-xs sm:text-sm lg:text-[15px] text-text-secondary">Currently open for new projects</span>
            ...
            >
              <form onSubmit={handleSubmit} className="p-5 sm:p-7 md:p-8 rounded-2xl glass-card aura-border">
                <div className="mb-6 sm:mb-8">
                  <h3 className="font-heading text-lg sm:text-xl lg:text-2xl font-bold text-text-primary mb-1.5">
                    Send a Message
                  </h3>
                  <p className="text-text-muted text-xs sm:text-sm lg:text-[15px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-4 sm:mb-5">
                  <div>
                    <label className="block text-xs sm:text-sm lg:text-[15px] font-semibold text-text-secondary mb-2">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                  <button
                    ...
                    className="w-full sm:w-auto px-8 py-4 sm:px-9 sm:py-4.5 bg-gradient-to-r from-primary to-primary-dark disabled:from-primary/30 disabled:to-primary-dark/30 disabled:cursor-not-allowed text-[#1a1a1a] text-base sm:text-lg font-semibold rounded-full border-2 border-primary/50 transition-all duration-300 hover:shadow-[0_0_35px_rgba(0,255,204,0.4)] hover:-translate-y-0.5 flex items-center justify-center gap-2.5"
                  >
                    {status === 'sending' ? (
