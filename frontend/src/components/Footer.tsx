            ...
            <div className="flex gap-2.5 sm:gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl glass-card flex items-center justify-center text-text-muted hover:text-primary-light hover:shadow-[0_0_12px_rgba(124,58,237,0.15)] transition-all duration-300"
                >
                  <s.icon />
                </a>
              ))}
